...
function M.get_dataset_buffer()
  ...
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.nav").move_cell(0, -1) end, opts) end
  k = state.get_keymap("sql_dataset", "move_down", "j")
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.nav").move_cell(1, 0) end, opts) end
  ...
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.page").prev_page() end, opts) end
  k = state.get_keymap("sql_dataset", "next_page", "L")
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.page").next_page() end, opts) end
  k = state.get_keymap("sql_dataset", "first_col", "0")
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.nav").goto_first_col() end, opts) end
  k = state.get_keymap("sql_dataset", "last_col", "$")
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.nav").goto_last_col() end, opts) end
  k = state.get_keymap("sql_dataset", "first_row", "gg")
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.nav").goto_first_row() end, opts) end
  k = state.get_keymap("sql_dataset", "last_row", "G")
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.nav").goto_last_row() end, opts) end
  k = state.get_keymap("sql_dataset", "preview_cell", "K")
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.nav").preview_cell() end, opts) end
  k = state.get_keymap("sql_dataset", "yank_cell", "yy")
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.nav").yank_cell() end, opts) end
  k = state.get_keymap("sql_dataset", "yank_column", "yc")
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.nav").yank_column() end, opts) end
  k = state.get_keymap("sql_dataset", "sort_column", "s")
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.nav").sort_by_current_col() end, opts) end
  k = state.get_keymap("sql_dataset", "toggle_cell_highlight", "zh")
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.nav").toggle_cell_highlight() end, opts) end
  k = state.get_keymap("sql_dataset", "toggle_header_float", "zH")
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.nav").toggle_header_float() end, opts) end
  k = state.get_keymap("sql_dataset", "toggle_row_numbers", "zN")
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.nav").toggle_row_numbers() end, opts) end
  k = state.get_keymap("sql_dataset", "toggle_raw_mode", "<leader>gp")
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.nav").toggle_raw_mode() end, opts) end
  ...
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.page").goto_first_page() end, opts) end
  k = state.get_keymap("sql_dataset", "goto_last_page", "<leader>ll")
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.page").goto_last_page() end, opts) end
  k = state.get_keymap("sql_dataset", "toggle_pagination", "<leader>pa")
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.page").toggle_pagination() end, opts) end
  k = state.get_keymap("sql_dataset", "find_column", "<leader>fc")
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.search").find_column() end, opts) end
  k = state.get_keymap("sql_dataset", "filter_by_cell", "<leader>ce")
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.search").filter_by_current_cell() end, opts) end
  k = state.get_keymap("sql_dataset", "show_search", "<leader>/")
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.search").show_search() end, opts) end
  k = state.get_keymap("sql_dataset", "clear_filter_search", "<leader>cr")
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.search").clear_filter_search() end, opts) end
  k = state.get_keymap("sql_dataset", "next_search", "n")
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.search").next_search_match() end, opts) end
  k = state.get_keymap("sql_dataset", "prev_search", "N")
  if k then vim.keymap.set("n", k, function() require("poste-sql.buffer.search").prev_search_match() end, opts) end
